...
const CustomerSupport = () => {
    ...
    return (
        <div className='px-20 py-20'>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto my-10 text-center">More than 100k+ customers have trusted and used our products. 
            ...
            <div  className="md:flex justify-center gap-8 mt-15">
                {
                    topRated.map(rating =>
                        <div  key={rating.id} className=" card bg-base-100 shadow-sm mb-5 w-full max-w-4xl">
